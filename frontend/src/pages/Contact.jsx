...
import { MapPin, Phone, Mail, Briefcase, Clock, Smartphone, Map } from "lucide-react";
      ...
      <div className="flex flex-col md:flex-row gap-10 md:gap-14 mb-10 items-start">
        ...
        <div className="flex flex-col gap-3 w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="p-5 flex flex-col gap-4">
                ...
                <div className="flex items-start gap-3 pb-4 border-b border-gray-100">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Care Connect Health Hub,<br />
                    Plot 12, Road No. 2, Banjara Hills,<br />
                ...
                >
                  <Phone size={14} className="text-indigo-400 shrink-0 group-hover:text-indigo-600" />
                 ...
                 <a href="tel:+919876543210"
                  className="flex items-center gap-3 hover:text-indigo-600 transition-colors group"
                >
                  <Smartphone size={14} className="text-indigo-400 shrink-0 group-hover:text-indigo-600" />
                  <span className="text-sm text-gray-500 group-hover:text-indigo-600">
                    (+91) 98765 43210
                  </span>
                </a>
                 ...
                 <a href="mailto:hello@careconnect.in"
                  className="flex items-center gap-3 hover:text-indigo-600 transition-colors group"
                >
                  <Mail size={14} className="text-indigo-400 shrink-0 group-hover:text-indigo-600" />
                  <span className="text-sm text-gray-500 group-hover:text-indigo-600">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden flex flex-col">
              ...
              <div className="p-5 flex flex-col gap-4 flex-1 justify-between">
                <p className="text-sm text-gray-500 leading-relaxed">
                  We're building the future of healthcare access in India. If you care about
                  meaningful work in engineering, design, or operations — we'd love to hear
                  from you.
                </p>
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-2xl px-5 py-3 flex items-center justify-between">
            ...
            <span className="flex items-center gap-1.5 text-[10px] font-medium px-3 py-1 rounded-full bg-green-50 text-green-600">
          ...
          {/* Map link */}
           ...
           <a href="https://maps.google.com/?q=Banjara+Hills+Road+No+2+Hyderabad"
            target="_blank"
          ...
          >
            <Map size={22} className="text-indigo-400 group-hover:text-indigo-600 transition-colors" />
